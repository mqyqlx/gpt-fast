...
#time python generate.py --compile --model_name Llama --model_size 7B --checkpoint_path $MODEL_REPO/model.pth --prompt "def quicksort(arr):" --max_new_tokens 128 --num_samples 3 --temperature 0.5 #--profile ./llama_talking_compile
#time python generate.py --compile --model_name Llama --model_size 13B --checkpoint_path $MODEL_REPO/model.pth --prompt "def quicksort(arr):" --max_new_tokens 128 --num_samples 3 --temperature 0.5 #--profile ./llama_talking_compile
time python generate.py --compile --model_name DCFormerLlama --model_size 13B --checkpoint_path $MODEL_REPO/model.pth --prompt "def quicksort(arr):" --max_new_tokens 128 --num_samples 6 --temperature 0.5 #--profile ./llama_talking_compile
#time python generate.py --compile --model_name DCFormerLlama --checkpoint_path $MODEL_REPO/model.pth --prompt "def quicksort(arr):" --max_new_tokens 128 --num_samples 3 --temperature 0.5 #--profile ./llama_talking_compile
